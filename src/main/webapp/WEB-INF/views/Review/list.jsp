...
<body>
<h3><img alt="후기" src="imgs/Review.png"> </h3>
		...
		<div class="box">
			...
			<ul>
				...
				<c:if test="${ ! empty loginInfo }">
					<li>
						<a class="btn-fill" href="new.re" style="margin-top: 0px;">글쓰기</a>
					</li>
				</c:if>
			</ul>
		</div>	
				...
				<tbody>
					...
					<c:forEach items="${page.list }" var="vo">
						<tr>
							...
							<td>${vo.rv_type }</td>
							<td>${vo.shop_name}</td>							
							<td class="left"><a onclick="go_detail(${vo.rv_id})">${vo.rv_title }</a></td>
							<td>${vo.name }</td>
