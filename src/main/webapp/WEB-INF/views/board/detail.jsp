...
textarea#comment { width:100%; height:60px; margin-top:5px; resize:none } 
</style>
</head>
<body>
<h3><img alt="" src="imgs/community.png"> </h3>
<table>
...
<tr><th>내용</th>
	<td colspan='5' class='left' style='text-align: justify;'>${fn:replace(vo.content, crlf, '<br>')}</td>
</tr>
<tr><th>첨부파일</th>
	<td colspan='5' class='left'>${vo.filename}
		<c:if test="${!empty vo.filename}">
		<a id='preview'></a>
		<a href='download.fb?id=${vo.id}'><i class='fas fa-download font-img'></i></a>
		</c:if>
	</td>
</tr>
