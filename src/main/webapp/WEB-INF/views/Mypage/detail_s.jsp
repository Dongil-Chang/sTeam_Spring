...
<div align="center">
<h3><img alt="" src="imgs/E info.png"></h3>
<table border="1">
	<tbody>
	<tr>
		<th>아이디</th>
	...
	<tr align="center">
		<td colspan="2">
			<a class='btn-fill' onclick="go_update('${vo.id}')">회원정보 수정</a>
			<a class='btn-fill' onclick="location.href='list.mp'">목록으로 가기</a>
		</td>
	</tr>
</table>
</div>
