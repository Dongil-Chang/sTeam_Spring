...
<div style="float: right;  font-weight: bold; color:#cc0073; padding: 10px 4%; margin-top: 20px; margin-right: 340px;">* 상호명을 클릭 후 지도가 띄워지고 주소를 클릭하면 후기 화면으로 이동합니다.
<br/> <span style="color: red; float:center;">단, 로그인은 필수 입니다.</span>
</div>
<div id="list-top"  style="width :40%; margin-left: 30px;"> 
