...
#list-top { float: left; padding: 10px 10%; margin-top: 30px; }
...
<div class="tb_list">
<h3><img alt="매장정보" src="imgs/shop.png"/> </h3>	
<div style="float: right; font-weight: bold; color:#cc0073; padding: 10px 10%; margin-top: 40px;">* 상호명을 클릭 후 지도가 띄워지고 주소를 클릭하면 후기 화면으로 이동합니다.</div>
<div id="list-top"> 
