...
<body>
<form method="post" action='login.ml'>
<div class="member_form">
				<h3 class="login"><a href='list.lg'>MEMBER LOGIN</a></h3>
				<ul>
				...
				<div >
					...
					<a href='member' > <img alt="" src="imgs/joinbtn.png"/> </a>
				</div>
				<ul>
					<li id="SL">Social Login</li>
				</ul>
				<div>
				<a href='naverLogin'><img src="imgs/loginNa.png"/></a>
	
				<a href='kakaoLogin'><img src="imgs/loginka.png"/></a>
				</div>
			</div>
	</form>
