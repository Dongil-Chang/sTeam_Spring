...
<body>
<h3><img alt="" src="imgs/QnA.png"> </h3>
...
<tr><th class="w-px120">제목</th>
	<td><input type="text" name="q_title" class="chk w-pct80" title="제목" value="${vo.q_title}" /></td>
</tr>
<tr><th class="w-px120">내용</th>
	<td><textarea name="q_content" class="chk w-pct80" title="내용" style="resixe:none; height: 370px;">${vo.q_content}</textarea></td>
</tr>
<tr><th>첨부파일</th>
	<td class="left">
