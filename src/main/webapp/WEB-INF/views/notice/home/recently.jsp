...
table { width: 450px; height: 315px; margin: 0 40px; }
...
<table>
<tr>
   <th colspan="2">Notice Update</th>
</tr>

<c:forEach items="${ad_list }" var="vo" begin="0" end="2">
<tr>
<td><a href="detail.no?id=${vo.id}&curPage=${curPage}"><span class="title">${vo.title}<img alt="" src="imgs/main_new.png"></span></a></td>
...
<tr>
<td><a href="detail.no?id=${vo.id}&curPage=${curPage}"><span class="title">${vo.title}</span></a></td>
<td><span class="date">${vo.writedate }</span></td>
</tr>
</c:forEach>
